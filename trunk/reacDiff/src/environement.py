...
class abstractEnvironnement(object):
    ...
    def dirichlet(self, x, y):
        """Quand on est dans la grille, on revoie les
        coordonnées et None et quand on est dehors, on renvoie
        les coordonnées et 0
        """
...
class list1d(abstractEnvironnement):
    def __init__(self, taille_x, taille_y, condition_bords):
